...
// $signed = hash_hmac('sha256', $signing, 'S-fY9ALc_KXaMOGGf-SMjjZg');
$signed = hash_hmac('sha256', $signing, 'S-cxKAxbi6rM_jrC8a87XBog');
if ($signed === $data['x_signature']) {
    if ($paidstatus == "Success"){
        ...
        $sqlupdatecart = "UPDATE `carts` SET `status`='paid' WHERE $subject_id = $prid";
